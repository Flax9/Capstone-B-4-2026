...
type LoginResponse struct {
	...
	UserFullname  string                 `protobuf:"bytes,4,opt,name=user_fullname,json=userFullname,proto3" json:"user_fullname,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginResponse) GetUserFullname() string {
	if x != nil {
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\ruser_fullname\x18\x04 \x01(\tR\fuserFullname2A\n" +
	"\vAuthService\x122\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\"\x00B\x15Z\x13capstone/proto/authb\x06proto3"
