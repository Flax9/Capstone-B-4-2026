...
const (
	BalanceService_CheckBalance_FullMethodName = "/balance.BalanceService/CheckBalance"
)
...
func (c *balanceServiceClient) CheckBalance(ctx context.Context, in *BalanceRequest, opts ...grpc.CallOption) (*BalanceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BalanceResponse)
	err := c.cc.Invoke(ctx, BalanceService_CheckBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBalanceServiceServer) CheckBalance(context.Context, *BalanceRequest) (*BalanceResponse, error) {
...
func _BalanceService_CheckBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BalanceServiceServer).CheckBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BalanceService_CheckBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BalanceServiceServer).CheckBalance(ctx, req.(*BalanceRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _BalanceService_CheckBalance_Handler,
		},
	},
